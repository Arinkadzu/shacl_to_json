...
export declare const strict: Record<keyof Discipline, NamedNode<string>> & ((property?: TemplateStringsArray | keyof Discipline | undefined) => NamedNode<string>) & Discipline;
