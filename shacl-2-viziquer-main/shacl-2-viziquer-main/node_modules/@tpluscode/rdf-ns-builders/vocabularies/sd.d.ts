...
export interface Sd {
    ...
    "availableGraphs": NamedNode<'http://www.w3.org/ns/sparql-service-description#availableGraphs'>;
    ...
    "defaultSupportedEntailmentProfile": NamedNode<'http://www.w3.org/ns/sparql-service-description#defaultSupportedEntailmentProfile'>;
    ...
    "EmptyGraphs": NamedNode<'http://www.w3.org/ns/sparql-service-description#EmptyGraphs'>;
    ...
    "endpoint": NamedNode<'http://www.w3.org/ns/sparql-service-description#endpoint'>;
    ...
    "inputFormat": NamedNode<'http://www.w3.org/ns/sparql-service-description#inputFormat'>;
    ...
    "languageExtension": NamedNode<'http://www.w3.org/ns/sparql-service-description#languageExtension'>;
    ...
    "name": NamedNode<'http://www.w3.org/ns/sparql-service-description#name'>;
    ...
    "namedGraph": NamedNode<'http://www.w3.org/ns/sparql-service-description#namedGraph'>;
    ...
    "propertyFeature": NamedNode<'http://www.w3.org/ns/sparql-service-description#propertyFeature'>;
    ...
    "RequiresDataset": NamedNode<'http://www.w3.org/ns/sparql-service-description#RequiresDataset'>;
    /** Relates an instance of sd:Service to a format that is supported for serializing query results. */
    "resultFormat": NamedNode<'http://www.w3.org/ns/sparql-service-description#resultFormat'>;
    /** An instance of sd:Service represents a SPARQL service made available via the SPARQL Protocol. */
    "Service": NamedNode<'http://www.w3.org/ns/sparql-service-description#Service'>;
    /** sd:SPARQL10Query is an sd:Language representing the SPARQL 1.0 Query language. */
    "SPARQL10Query": NamedNode<'http://www.w3.org/ns/sparql-service-description#SPARQL10Query'>;
    /** sd:SPARQL11Query is an sd:Language representing the SPARQL 1.1 Query language. */
    "SPARQL11Query": NamedNode<'http://www.w3.org/ns/sparql-service-description#SPARQL11Query'>;
    /** sd:SPARQLUpdate is an sd:Language representing the SPARQL 1.1 Update language. */
    "SPARQL11Update": NamedNode<'http://www.w3.org/ns/sparql-service-description#SPARQL11Update'>;
    ...
    "supportedEntailmentProfile": NamedNode<'http://www.w3.org/ns/sparql-service-description#supportedEntailmentProfile'>;
    /** Relates an instance of sd:Service to a SPARQL language (e.g. Query and Update) that it implements. */
    "supportedLanguage": NamedNode<'http://www.w3.org/ns/sparql-service-description#supportedLanguage'>;
    ...
    "UnionDefaultGraph": NamedNode<'http://www.w3.org/ns/sparql-service-description#UnionDefaultGraph'>;
}
export declare const strict: Record<keyof Sd, NamedNode<string>> & ((property?: TemplateStringsArray | keyof Sd | undefined) => NamedNode<string>) & Sd;
